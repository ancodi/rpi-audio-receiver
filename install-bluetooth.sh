...
apt install -y --no-install-recommends pkg-config libtool libglib2.0-dev libdbus-1-dev libbluetooth-dev libasound2 libasound2-dev alsa-tools libsbc-dev git automake build-essential python3-docutils
# Install Codecs
